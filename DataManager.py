...
def reformat_inputFile(input_file_name, index_file_name, file_id):
	"""
	...
	matrix_file_name = "DATA/data_formated"+str(file_id)+".csv"
	label_file_name = "DATA/data_formated_label"+str(file_id)+".csv"
